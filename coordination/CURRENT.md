...
| 3D Viewer / World / Assets | Codex / The Beast | SLICE_C_DONE_LOCAL_ONLY | Freigegebene local-only Ableitung aus installiertem Anubis Build `24828357`: 27 normale Weltgruppen, 673.869 Triangles, GLB/`.tri` gehasht, Identitätstransform, reale Positions-/Höhenüberlagerung und sichtbar/blockiert-LOS bestanden; Maschinen-Gate `available`. Alles bleibt ignoriert und nicht distributabel. NEXT: Slice D minimaler Renderer-Vertrag/native Embed-Spike, ohne Asset-Packaging. |
