...
| Improve Yourself – Experimental | Codex / The Beast | REVIEW | Funktionaler E2E-Ablauf und Designreferenzen sind zusammengeführt. `docs/design/Improve_Yourself_Concept_Preview_Discord_Q98.pdf` ist jetzt die versionierte visuelle Master-Referenz, während der Branch funktionale Wahrheit bleibt. Der aktuelle Build erfüllt Marke, dunkle Shell/Sidebar, Akzent- und Kartenhierarchie; flachere Oberflächen, geringere metallische Tiefe/Lichtreflexe, sparsame Iconografie und niedrigere Paneldichte sind als sichtbare Restabweichungen dokumentiert. Keine PDF-Beispieldaten oder alten Apply-/Score-Funktionen wurden übernommen. Reproduzierbarer Ancient-Realcheck: 18 Runden, 10 benannte Spieler und 54 Szenen; unterstützter Testerstart bleibt unverändert. |
