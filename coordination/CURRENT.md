...
| 3D Viewer / World / Assets | Codex / The Beast | READY_FOR_IMPLEMENTATION | Geschlossene V1-Spezifikation mit Assetvertrag, `iy.replay/v2`, Testmatrix, Slice-/COMPLETE-Gates und strikter V1/V2-Grenze liegt vor. Erster Implementierungsschnitt ist ausschließlich Slice A: kanonischer Full-Match-Vertrag + reale Anubis-Capability-Regression; noch keine Renderer-Abhängigkeit. |
