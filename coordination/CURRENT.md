...
| 2D Analyzer / Viewer | Codex / The Beast | BLOCKED | Reale Datenfähigkeit und vorgeschlagene `iy.replay/v1`-Grenze sind inventarisiert; für reproduzierbares Rendering fehlen freigegebenes Radarasset samt Transformation sowie Scene- und Samplingregel. Siehe `docs/2D_VIEWER_FOUNDATION.md`. |
