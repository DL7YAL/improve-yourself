...
| Demo Analyzer / echter neutraler Szenenfluss | Codex / The Beast | REVIEW_RUNTIME_PENDING | Neuer Flow auf kanonischem Replay v2: echte Namen/Start-Line-ups, Full Demo oder deduplizierte Multi-Player-Auswahl mit CT/T/Reset, neutrale Profile/Regeln, objektive Kill-/Headshot-/Wallbang-/Smoke-/Entry-/Multi-Kill-Anker, Kontextfenster und Szenen-Merge. Reale 477-MB-Mirage-Demo: 30 Runden, 10 Spieler, 201 Kills, 375 Marker → 97 Szenen; Player Select 35. JSON/Timeline/HTML und `demo_gototick 6352` erzeugt, 97 Tests/7 CLIs grün. OPEN: tatsächlichen Sprung in CS2 bestätigen; UI-Automation stoppte sicher wegen aktiver Nutzereingabe. |
