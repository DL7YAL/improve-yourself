...
| Demo Analyzer / lokale Desktop-Shell | Codex / The Beast | DONE | Dünner Tk-Adapter über der einzigen `iy-demo-workflow`-/Replay-v2-Wahrheit: reale Demo-Auswahl, Roster/Player Select ohne Reparse und fail-closed “In CS2 öffnen”. Zusätzlich öffnet die Shell ausschließlich ein explizit gewähltes `demo-workflow.json`, prüft Schema/Status/Policy, Hashkonsistenz, eingeschlossene Pflichtartefakte und alle Replay-Chunks und stellt dann Auswahl/Review ohne Awpy wieder her. Kein Ordnerscan oder Recent-Autoselect. Der echte Ancient-Stand wurde so mit 10 Spielern/54 Szenen wiederhergestellt. 109 Tests/8 CLIs grün. NEXT: optionales explizites Quelldemo-Zuordnen nur nach SHA-256-Gleichheit; kein Suchen/Raten/Kopieren. |
