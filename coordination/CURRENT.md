...
| 3D Viewer / World / Assets | Codex / The Beast | SLICE_A_DONE | `iy.replay/v2` Full-Match-Vertrag, Builder, Validator, hashgeprüfter Round-Store und reale Anubis-Regression sind grün (42 Runden, 252.401 Frames, 2.524.000 Player-States). Vor Slice B muss die kanonische Tickrate evidenzbasiert geklärt werden; danach gemeinsamer ReplayController und 2D-Migration, weiterhin ohne Renderer. |
