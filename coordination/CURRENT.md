...
| 2D Analyzer / Viewer | Codex / The Beast | DONE | `iy.replay/v1` exportiert reale Multi-Kill-Szenen mit begrenzten Positions-/Blickrichtungsframes; offizielle lokale Awpy-Mapressource und Transformation sind reproduzierbar dokumentiert. Ein UI-Renderer bleibt ein getrenntes Folgeobjekt. |
