...
2. Benchmark-Abnahme: den bereits kompilierten V1.2-Kandidaten im normalen Viewer an den fünf `pass=measured`-Markern aufnehmen und die tatsächliche Landmark-Sichtbarkeit bestätigen. Performancewerte erst freigeben, wenn ein separater Messsammler seinen aktiven Zustand und verwertbare FPS-/Frametime-Daten belegt. Der ältere VRAD-Preflight-/Full-Compile-Blocker bleibt für einen späteren VMAP-Neubau separat offen; keine Treiber-, Registry-, Adrenalin- oder Sicherheitsfilter-Änderung daraus ableiten.
