...
| 3D Viewer / World / Assets | Codex / The Beast | SIGHTLINE_PRESENTATION_DONE | Bereits evaluierte `SightlineResult`-Werte werden als tick-/spielergebundene Eye-to-eye-Segmente mit festen Grün/Rot/Grau-Farben an den Renderer übergeben; dieser berechnet Geometrie/Smoke nicht neu. Realer Anubis-Tick 6401 blieb über TP→FP→TP identisch, Resize/Dispose und roter Occluded-Sichtnachweis bestanden; 84 Tests grün. NEXT: ausschließlich kanonisches Smoke-Evidenz-Gate mit Full-Coverage-Anforderung und offengelegter V1-Näherung; noch kein Smoke-/Utility-Rendering. |
