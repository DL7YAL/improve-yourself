...
| Improve Yourself – Experimental | Codex / The Beast | REVIEW | Funktionaler E2E-Ablauf und `docs/design/` sind zusammengeführt. Reproduzierbarer Ancient-Realcheck: 18 Runden, 10 benannte Spieler und 54 Szenen; alle sieben Reiter, geladene Zustände und read-only System Check visuell bestanden. Unterstützter Testerstart `tools/dev/Start-Experimental.ps1` öffnet die normale Auswahl oder exakt ein fail-closed validiertes Manifest ohne Scan/Reparse; real mit Ancient gestartet. Missing-/Falscher-Dateiname-Tests ergänzen den Launcher. 122/122 Tests, Compile und Diff-Check PASS. |
