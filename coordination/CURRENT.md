...
| Demo Analyzer / lokale Desktop-Shell | Codex / The Beast | DONE | Dünner Tk-Adapter über der einzigen `iy-demo-workflow`-/Replay-v2-Wahrheit: lokale Demo-Auswahl, Background-Import, echte CT/T-Line-ups, getrennte Full-Demo-/Player-Select-Modi, dedupliziertes Dropdown + Add Player, CT/T/Reset, Auswahl-Rerender ohne Reparse und vorhandenes Review öffnen. Reale Ancient-Einzelauswahl erzeugte 22 Szenen aus demselben Store. 100 Tests/8 CLIs und sichtbarer Start-/Close-Smoke PASS. NEXT: nur einen engen lokalen Szenen-zu-CS2-Tick-Coordinator anbinden. |
