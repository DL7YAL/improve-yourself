...
| Improve Yourself Preview V1.1 Folgepass | Codex / The Beast | LOCKED | Ungemergter Branch `beast/analyzer-default-criteria-v1`: V1 bleibt unverändert als Fallback. Der Folgepass baut ausschließlich die freigegebene Desktop-/Wide-UX, produktseitige Navigatorstruktur und Branding-Konsistenz aus. Variante 3 ist die alleinige Markenquelle: horizontaler Wortmarken-Ausschnitt im Header; quadratisches Mehrgrößen-ICO des originalen Balken-/I-Symbols für EXE, Fenstertitelleiste und Taskleiste. Noch kein V1.1-Releasepaket. |
