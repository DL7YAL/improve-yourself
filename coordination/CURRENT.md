...
| Benchmark Multi-Map-Transitions | Codex / The Beast | WAITING_FOR_TRISTAN | Steam-Dateiprüfung für CS2 (730) und SDK (745) ist abgeschlossen; Workshop Tools und Hammer starten wieder. Die Benchmark-VMAP lädt. Der nun erneut gestartete Full Compile endet vor der eigentlichen Build-Pipeline am Hammer-Dialog `GPU Lightmap Baking`: GPU-Raytracing-Unterstützung wird verlangt. Keine Smoke-, Geometrie-, Controller- oder Treiberänderung wurde vorgenommen. Tristan entscheidet über einen Treiber-/GPU- oder offiziell dokumentierten Baking-Setup-Schritt; danach Full Compile und marker-synchronisierten Kameramesslauf fortsetzen. |
...
## Nächste Schritte
1. Tristan: Für Hammer `GPU Lightmap Baking` eine freigegebene, nachvollziehbare Lösung bereitstellen bzw. einen GPU-/Treiber- oder dokumentierten Baking-Setup-Schritt freigeben. Die Steam-/SDK-Dateiprüfung ist bereits erfolgt und Hammer startet wieder. Danach Full Compile wiederholen und den marker-synchronisierten Kameraabgleich fortsetzen.
