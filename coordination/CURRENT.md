...
| 3D Viewer / World / Assets | Codex / The Beast | REVIEW | Technische Vorprüfung dokumentiert: `iy.replay/v1` belegt Positionen/Blickwinkel für Szenen, deckt aber noch kein vollständiges Match und keinen gemeinsamen Playback-Controller ab. Renderer bleibt außerdem durch ungeprüfte Anubis-Geometrie-Provenienz und die offene native Desktop-Shell blockiert. |
