...
| System Check / Analyzer Output V1 | Codex / The Beast | WAITING_FOR_TRISTAN — System Check / Analyzer UX review | Korrigierte Nutzeransicht ist erneut lokal review-bereit: Secure Boot und TPM 2.0 sind sichtbar Teil der Anti-Cheat-Readiness. Der reale read-only Check bestätigt auf diesem Rechner beide Kriterien; bei fehlender Bestätigung zeigt Improve stattdessen verständlich „Nicht vollständig bestätigbar“, den manuellen Prüfweg und ausdrücklich keinen Deaktiviert-Schluss. Analyzer trennt weiter Fakten, Prüfhinweise und Datenlücken. Frischer realer `iy.workflow/v1`-Lauf ist `READY_FOR_REVIEW`. |
