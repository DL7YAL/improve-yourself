...
| Demo Analyzer / lokale Desktop-Shell | Codex / The Beast | DONE | Dünner Tk-Adapter über der einzigen `iy-demo-workflow`-/Replay-v2-Wahrheit: reale Demo-Auswahl, Roster/Player Select ohne Reparse und fail-closed “In CS2 öffnen”. Explizites Wiederöffnen prüft Schema/Status/Policy, Hashkonsistenz, eingeschlossene Pflichtartefakte und alle Replay-Chunks. `Quelldemo zuordnen` persistiert nach vollständiger SHA-256-Gleichheit atomar nur den Basename und wiederholt die Readiness; bei Mismatch bleibt das Manifest unverändert. Kein Scan/Reparse/Suchen/Raten/Kopieren. 111 Tests/8 CLIs grün. NEXT: diese Manifestintegrität unmittelbar vor jedem Rerender-/Review-Zustandswechsel erneut prüfen. |
