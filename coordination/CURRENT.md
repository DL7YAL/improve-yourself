...
| Preview V1 Windows Packaging | Codex / The Beast | WAITING_FOR_TRISTAN — ZIP re-review | Nach dem gemeldeten externen Entpackfehler wurde der ursprüngliche ZIP lokal gegen den gemeldeten Hash geprüft: SHA-256 `DBCFCB…402DB74B`, .NET-Öffnung und Windows-Entpackung PASS. Neues, separat benanntes Windows-.NET-Standard-ZIP ist die alleinige Weitergabeempfehlung: `Improve-Yourself-Preview-V1-Windows.zip`, SHA-256 `C03F5B…1461B825`. Es wurde frisch mit Windows `Expand-Archive` entpackt und die EXE-UI/Analyzer-Einstieg lokal gestartet. Keine Produktinhalte wurden geändert. |
