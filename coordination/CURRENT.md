...
| Demo Analyzer / lokale Desktop-Shell | Codex / The Beast | DONE | Dünner Tk-Adapter über der einzigen `iy-demo-workflow`-/Replay-v2-Wahrheit: lokale Demo-Auswahl, Background-Import, echte CT/T-Line-ups, getrennte Full-Demo-/Player-Select-Modi, dedupliziertes Dropdown + Add Player, CT/T/Reset und Rerender ohne Reparse. Das bestehende Review bietet nun “In CS2 öffnen” über einen fail-closed Loopback-Coordinator: aktiver Demo-Modus, exakter Dateiname und kanonisches Scene-ID/Tick-Paar sind Pflicht. Real `iy_ancient.dem`/`r1-t3654-0`/Tick 3654 landete sichtbar bei etwa 0:57. 103 Tests/8 CLIs PASS. NEXT: nur erklärenden Readiness-Preflight in die Shell aufnehmen; kein CS2-Launch-/Steam-/Kopierautomatismus. |
