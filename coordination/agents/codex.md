...
NEXT: Ausschließlich `my_improvement_MASTER.png` nach derselben Reference-Locked-Methode prüfen und angleichen; anschließend erst `benchmark_MASTER.png`. Keine neue Produktfunktion, Replay-Logik oder Datenquelle beginnen.
...
COMMIT/PR: Tactical-/Demo-Card-Runtime-Checkpoint wird nach dem finalen Arbeitsbaum-/Diff-Check auf `dev/v1-foundation` gesichert und gepusht.
