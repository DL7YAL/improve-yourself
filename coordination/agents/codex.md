...
NEXT: Ausschließlich `demo_analyzer_MASTER.png` gegen seinen aktuellen Runtime-Screen prüfen und innerhalb des UI-Scopes finalisieren; danach erst `tactical_viewer_MASTER.png`.
