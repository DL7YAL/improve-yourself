...
def test_optimizer_ui_keeps_a_2x2_grid_local_detail_scroll_and_neutral_area_identity() -> None:
    ...
    assert 'accent = _OPTIMIZER_THEME["accent"] if active else _OPTIMIZER_THEME["secondary"]' in source
    assert 'text="IMPROVE\\nYOURSELF"' in source
