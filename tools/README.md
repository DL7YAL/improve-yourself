...
- `dev/Build-LocalAnubisAsset.py` — convert an explicitly authorized,
  already-extracted current-build physics GLB into an ignored local-only
  replay-space render/visibility bundle; it grants no distribution rights
